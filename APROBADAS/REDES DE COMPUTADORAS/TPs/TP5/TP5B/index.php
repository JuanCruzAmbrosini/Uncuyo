...
<body>
    ...
    <p>Boca Juniors: <?php echo $votos['boca']; ?> votos</p>
    <p>River Plate: <?php echo $votos['river']; ?> votos</p>
    <p>Independiente: <?php echo $votos['independiente']; ?> votos</p>
    <p>Racing Club: <?php echo $votos['racing']; ?> votos</p>
    <p>San Lorenzo: <?php echo $votos['sanlorenzo']; ?> votos</p>
    
    <p>Otro: <?php echo $votos['otro']; ?> votos</p>
