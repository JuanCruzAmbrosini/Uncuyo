...
def shiftDown(list : LinkedList, index : int):
    ...
    if leftIndex < n or rightIndex < n:

        if leftIndex < n:
            if searchNodeIndex(list, leftIndex).value > searchNodeIndex(list, maxIndex).value : 
                maxIndex = leftIndex

        if rightIndex < n:
            if searchNodeIndex(list, rightIndex).value > searchNodeIndex(list, maxIndex).value : 
                maxIndex = rightIndex

        if maxIndex != index: 

            swap(list, maxIndex, index)
            shiftDown(list, maxIndex)

"""----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----"""

def shiftDownTo(list : LinkedList, index : int, till : int):
    ...
    if (leftIndex < n or rightIndex < n) :
        ...
        if maxIndex != index: 
            ...
            swap(list, maxIndex, index)
            shiftDownTo(list, maxIndex, till)

"""----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----  ----"""

def heapSort(list : LinkedList) :
